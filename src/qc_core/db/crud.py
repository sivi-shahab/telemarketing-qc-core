...
def list_collection_results(
    ...
    *,
    ...
    """
    from qc_core.compliance.collection_report import is_collection_result_json, normalize_stored_report
...
def get_daily_stats(db: Session, customer_ids: Optional[list[str]] = None) -> list[dict]:
    ...
    # ``exclude_collection_campaigns``).
    from qc_core.compliance.campaign_kind import collection_campaigns_from_env
